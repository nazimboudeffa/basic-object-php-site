 ...
 * ));
 */
class BobjpsDatabase extends BobjpsBase {
		/**
		...
		public function Connect() {
				$settings = bobjps_database_settings();
				$options  = array(
				...
				try {
						...
						throw new BobjpsDatabaseException($ex->getMessage());
				}
		}
		/**
